...
switch (search) {
  case 1:
    console.log("Bạn đã chọn tìm kiếm theo tên");
    break;
  case 2:
    console.log("Bạn đã chọn tìm kiếm theo tác giả");
    break;
  case 3:
    console.log("Bạn đã chọn tìm kiếm theo nhà xuất bản");
    break;
  case 4:
    console.log("Bạn đã chọn tìm kiếm theo tiêu đề");
    break;
  default:
    console.log("Phím bấm không hợp lệ");
}
